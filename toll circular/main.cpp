...
static void key(unsigned char key1, int x, int y)
{
	...
	void welcome()
	{
			...
			glColor3f(0.0,1.0,1.0);
	 		...
	 		drawstring(180,260,0.0,"GOUSE, JOYCE, SANJANA, PRERNA");
		...
		void frontscreen()
	{
		...
		glColor3f(0.0,0.0,0.0);
	 	...
	 	glColor3f(0.0,0.0,1.0);
	 		drawstring2(20,265,0.0,"Sanjana Astoti 2JH20CS078");
	 		drawstring2(20,240,0.0,"B Prerna Naidu 2JH20CS012");
	 		drawstring2(20,290,0.0,"Md.Gouse.M.Killedar 2JH20CS042");
	 		drawstring2(20,315,0.0,"Joyce Dola 2JH20CS027");
	 	glColor3f(1.0,1.0,1.0);
	 		drawstring1(10,225,0.0,"Under the Guidance of");
	 	glColor3f(0.0,1.0,0.0);
	 		drawstring2(20,200,0.0,"Prof.Sahana B ");
	 	glColor3f(0.0,0.0,0.0);
...
void display()
{
	...
	else
	{
		...
		glEnd();
			...
			// display instruction for demo car

				glColor3f(0.0,0.0,0.0);
				drawstring1(ax+0,140,0,"Car Demo");
                drawstring1(ax+0,130,0,"instructions:");
		 		drawstring1(ax+0,120,0,"o:open barrier");
